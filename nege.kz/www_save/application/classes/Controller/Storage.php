    ...
    public function action_upload()
    {
        ...
        if ($type=='Img'){
            ...
            $validate->rules('file',array(
                array("Upload::not_empty"),
                array("Upload::valid"),
                array("Upload::type",array(":value",array('doc', 'docx', 'pdf', 'rar','zip', 'xls', 'xlsx','txt', 'swf', "png","jpg","gif","jpeg",'mp3'))),
...
//        $this->request->redirect('storage/index');
    ...
    public function action_crop()
    {
        ...
        $model->metadata($meta);
        $model->save();
        $this->response->body(URL::site($path));
    }

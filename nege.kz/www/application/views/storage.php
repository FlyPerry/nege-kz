        ...
        <div class="span12">
            ...
            <div class="tab-content">
                <div ng-controller="CtrlFileUploader" id="upload" class="tab-pane active">
                    ...
                    <form action="<?=Url::site('ru/storage/upload')?>/{{type}}" ng-upload>
                        <label form="water"><input type="checkbox" id="water" name="water" value="1"> Наложить ватермарк </label><br/>

...
<div class="btn-toolbar">
	...
	<?php if ($first_page !== FALSE): ?>
		<a href="<?php echo HTML::chars($page->url($first_page)) ?>" rel="first" class="btn"><?php echo __('<<') ?></a>
	<?php else: ?>
		<a class="btn"><?php echo __('<<') ?></a>
	<?php endif ?>
	...
	<?php foreach ($links as $number => $content): ?>
		...
		<?php if ($number === $current_page): ?>
                <a href="#" class="btn btn-raised"><?php echo $content ?></a>

		<?php else: ?>
			<a class="btn" href="<?php echo HTML::chars($page->url($number)) ?>"><?php echo $content ?></a>
		<?php endif ?>
	...
	<?php if ($last_page !== FALSE): ?>
		<a href="<?php echo HTML::chars($page->url($last_page)) ?>" rel="last" class="btn"><?php echo __('>>') ?></a>
	<?php else: ?>
		<a class="btn"><?php echo __('>>') ?></a>
	<?php endif ?>
    </div>

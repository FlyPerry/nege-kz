...
class Controller_Flexiblemigrations extends Kohana_Controller_Template {
  ...
  protected $view;
	...
	public function before() 
	{
		...
		$this->migrations = new Flexiblemigrations();
		try 
		{
	...
	public function action_index() 
	{
		...
		$this->view->set_global('migrator', $this->migrations);
	...
	public function action_new() 
	{
		...
		$this->view = View::factory('flexiblemigrations/new')->set('modules',$modules);
		$this->template->view = $this->view;
	}
	...
	public function action_create() 
	{
		...
		try 
		{
			...
			if ($this->migrations->generate_migration($migration_name,$this->request->post('module'))){
                $session->set('message', "Migration ".$migration_name." was succefully created. Check migrations folder");
            } else {
                $session->set('message', "Migration ".$migration_name." was not created.");
            }
	    }
	    catch (Exception $e) 
	    { 

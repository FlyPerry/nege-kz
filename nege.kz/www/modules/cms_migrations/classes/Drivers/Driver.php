...
abstract class Drivers_Driver extends Drivers_Common
{
    ...
    abstract public function add_foreign_key($table,$field,$name,$fk_table,$fk_field,$on_delete="cascade",$on_update="no");
